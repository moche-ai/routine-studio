...
async def test():
    ...
    # denoise를 높여서 변화 적용
    tests = [
        {"name": "red_d15", "denoise": 0.15},
        {"name": "red_d20", "denoise": 0.20},
        {"name": "red_d25", "denoise": 0.25},
        {"name": "red_d30", "denoise": 0.30},
    ]
    
    instruction = "Transform into an Asian man with black hair, wearing glasses, dressed in a bright RED suit with red jacket. Keep the same cartoon style."
